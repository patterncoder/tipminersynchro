    ...
    <group name="tipminersynchroGroup" generation="1" functional="0" release="0">
      <settings>
        <aCS name="WorkerRole1:Microsoft.WindowsAzure.Plugins.Diagnostics.ConnectionString" defaultValue="">
          <maps>
            <mapMoniker name="/tipminersynchro/tipminersynchroGroup/MapWorkerRole1:Microsoft.WindowsAzure.Plugins.Diagnostics.ConnectionString" />
          </maps>
        </aCS>
        <aCS name="WorkerRole1Instances" defaultValue="[1,1,1]">
          <maps>
            <mapMoniker name="/tipminersynchro/tipminersynchroGroup/MapWorkerRole1Instances" />
          </maps>
        </aCS>
      </settings>
      <maps>
        <map name="MapWorkerRole1:Microsoft.WindowsAzure.Plugins.Diagnostics.ConnectionString" kind="Identity">
          <setting>
            <aCSMoniker name="/tipminersynchro/tipminersynchroGroup/WorkerRole1/Microsoft.WindowsAzure.Plugins.Diagnostics.ConnectionString" />
          </setting>
        </map>
        <map name="MapWorkerRole1Instances" kind="Identity">
          <setting>
            <sCSPolicyIDMoniker name="/tipminersynchro/tipminersynchroGroup/WorkerRole1Instances" />
          </setting>
        </map>
      </maps>
      <components>
        <groupHascomponents>
          ...
          <sCSPolicy>
            <sCSPolicyIDMoniker name="/tipminersynchro/tipminersynchroGroup/WorkerRole1Instances" />
            <sCSPolicyUpdateDomainMoniker name="/tipminersynchro/tipminersynchroGroup/WorkerRole1UpgradeDomains" />
            <sCSPolicyFaultDomainMoniker name="/tipminersynchro/tipminersynchroGroup/WorkerRole1FaultDomains" />
          </sCSPolicy>
        </groupHascomponents>
      </components>
      <sCSPolicy>
